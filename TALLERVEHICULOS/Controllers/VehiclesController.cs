...
namespace TALLERVEHICULOS.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Year,Doors,BrandId")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,Year,Doors,BrandId")] Vehicle vehicle)
        {
            if (id != vehicle.Id)
            {
                return NotFound();
